                  ...
                  {cvData?.methods && Object.entries(cvData.methods).map(([method, count]) => (
                    count > 0 && (
                      <div key={method} className={cn(
                        ...
                        method === 'holo' && "border-pink-500/30 bg-pink-500/10 text-pink-600 dark:border-pink-500/40 dark:bg-pink-500/20 dark:text-pink-300",
                        ...
                        {method === 'holo' ? 'Holo 1.5-7B' : method}: {count}
                      </div>
                    )
                  ))}
                      ...
                      <div key={idx} className="rounded border border-border bg-muted/30 px-2 py-1 text-[10px] dark:bg-muted/40">
                        ...
                        <div className="flex items-center gap-2 mt-0.5 text-[9px] text-muted-foreground">
                          <span className={cn(
                            ...
                            {detection.primaryMethod === 'holo-1.5-7b' ? 'Holo 1.5-7B' : detection.primaryMethod}
                          </span>
                          {detection.cached && (
